...
ShaderProgram::ShaderProgram(const char* vertexFile, const char* fragmentFile) {
	...
	m_uniforms[CAMERA_UNIFORM] = glGetUniformLocation(m_program, "MVP");
}
...
void ShaderProgram::SetUniformMat4(glm::mat4 matrix)
{
	glUniformMatrix4fv(m_uniforms[CAMERA_UNIFORM], 1, GL_FALSE, &matrix[0][0]);
}
